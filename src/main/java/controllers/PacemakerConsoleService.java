...
public class PacemakerConsoleService {
    ...
    public void login(@Param(name = "email") String email,
        ...
        java.util.Optional<User> user = java.util.Optional.ofNullable(paceApi.getUserByEmail(email));
        if (user.isPresent()) {
    ...
    public void addActivity(
        ...
        java.util.Optional<User> user = java.util.Optional.ofNullable(loggedInUser);
        user.ifPresent(value -> console
                .renderActivity(paceApi.createActivity(value.id, type, location, distance)));
    }
    ...
    public void listActivities() {
        java.util.Optional<User> user = java.util.Optional.ofNullable(loggedInUser);
        user.ifPresent(value -> console
                .renderActivities(paceApi.getActivities(value.id)));
    }
    ...
    public void listActivityLocations(@Param(name = "activity-id") String id) {
        ...
        Optional<Activity> activity = Optional.fromNullable(paceApi.getActivity(loggedInUser.getId(), id));
        if (activity.isPresent()) {
            console.renderLocations((List<Location>) paceApi.getActivityLocations(loggedInUser.id, id));
        }
    }
    ...
    public void messageAllFriends(@Param(name = "message") String message) {
        java.util.Optional<User> user = java.util.Optional.ofNullable(loggedInUser);
        user.ifPresent(value -> console.println(paceApi.messageAllFriends(value.id, message)));
    }
